<x-app-layout>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="areas d-flex justify-content-around flex-wrap p-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mt-4 parrafo_main">Gestiona tus documentos y procesos legales de manera
                                eficiente. Descubre todas las herramientas jurídicas disponibles.</span>
                            <span
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mt-4 parrafo_main">Administra y controla la información de socios de
                                manera eficiente. Descubre todas las herramientas para gestionar y actualizar datos de
                                miembros.</span>
                            <a href="/menu/socios"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mt-4 parrafo_main">Controla tus finanzas con precisión. Accede a
                                herramientas esenciales para la gestión contable eficiente.</span>
                            <span
                                class="btn btn-sm btn-ligh mt-3 border fw-semibold text-secondary w-75 m-auto btn-ingresar-modulo">Ingresar</span>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mt-4 parrafo_main">Gestiona talento y desarrollo profesional de forma
                                efectiva. Descubre herramientas clave para optimizar el capital humano.</span>
                            <span
                                class="btn btn-sm btn-ligh mt-3 border fw-semibold text-secondary w-75 m-auto btn-ingresar-modulo">Ingresar</span>
                        </div>
                    </div>
